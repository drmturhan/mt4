        ...
        return this.http.post('/connect/token', this.encodeObjectToParams(data), options)
            ...
            .map((tokens: AuthTokenModel) => {
                ...
                var dikkat: Toast = {
                    type: 'success',
                    timeout: 12000,
                    title: 'Sisteme giriş başarılı.',
                    body: `Sisteme güvenli bir şekilde girildi.`
                };
                this.toasterService.pop(dikkat);
            },
            (
                err: any) => {
                ...
                var dikkat: Toast = {
                    type: 'error',
                    timeout: 12000,
                    title: 'Sisteme giriş başarısız.',
                    body: `Sisteme giriş yapılamadı!!`
                };
                this.toasterService.pop(dikkat);
            });
                ...
                return this.getTokens({ refresh_token: tokens.refresh_token }, 'refresh_token')
                    ...
                    .catch((error: any) => {
                        ...
                        var dikkat: Toast = {
                            ...
                            body: `Otomatik yeni oturum açılamadı. Lütfen yeniden giriş yapın`
                        };
                        this.toasterService.pop(dikkat);
                        return Observable.throw(dikkat.title + dikkat.body);
                    });
            });
    }
            ...
            .flatMap(tokens => {
                ...
                if (!tokens) {
                    ...
                    var dikkat: Toast = {
                        type: 'warning',
                        timeout: 12000,
                        title: 'Kullanıcı bilgileri bulunamadı! ',
                        body: `Lütfen yeniden giriş yapın`
                    };
                    this.toasterService.pop(dikkat);
                    return Observable.throw(dikkat.title + dikkat.body);
                }
