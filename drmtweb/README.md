...
Yeni DBye DB Migration Adýmlarý

1. Veritabaný adýný düzenlemek için appsetting deki connectionstrigi ayarla
2. update-database -c ApplicationDbContext
3. update-database -c KisiDbContext
4. update-database -c UlkeDbContext
5. update-database -c DoktorDbContext
6. update-database -c OtelDbContext
7. update-database -c SigortaDbContext
8. update-database -c IlacDbContext
9. update-database -c TelefonKayitDbContext
10.update-database -c KurDbContext
10.update-database -c MuayeneDbContext
11.update-database -c PostaDbContext
12.update-database -c LogDbContext


Aktarým baþlamdan önce KaliptusKayna veritabanýnda
Kisi tablosununda YeniId leri null yap
Muayene tablosununda YeniId leri null yap
Otel tablosununda YeniId leri null yap
Sigorta tablosununda YeniId leri null yap



admin@admin.com   P@ssw0rd!




Yeni Kaliptus server connection string 
Server=tcp:kaliptusdbserver.database.windows.net,1433;Initial Catalog=Kaliptus2020Db;Persist Security Info=False;User ID=mturhan;Password=akd.34632017;MultipleActiveResultSets=true;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;


local db connection string 
server=.;database=Kaliptus2021;integrated security=true;MultipleActiveResultSets=true;

"SqlServerConnectionString": "server=.;database=Kaliptus2021;integrated security=true;MultipleActiveResultSets=true;"


"SqlServerConnectionString": "server=.;database=Kaliptus2020Db;integrated security=true;MultipleActiveResultSets=true;"


"SqlServerConnectionString": "Server=tcp:kaliptusdbserver.database.windows.net,1433;Initial Catalog=Kaliptus2020Db;Persist Security Info=False;User ID=mturhan;Password=akd.34632017;MultipleActiveResultSets=true;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"
...
Kaliptus Migration
 ...
 <add name="KaliptusModel" connectionString="data source=.;initial catalog=Kaliptus2021;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework" providerName="System.Data.SqlClient" />


<add name="KaliptusModel" connectionString="Server=tcp:kaliptusdbserver.database.windows.net,1433;Initial Catalog=Kaliptus2020Db;Persist Security Info=False;User ID=mturhan;Password=akd.34632017;MultipleActiveResultSets=true;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;App=EntityFramework" providerName="System.Data.SqlClient" />



EXCEL Þifre akd.346300.kaliptus.2017



AspNetCoreSpa DrMturhan