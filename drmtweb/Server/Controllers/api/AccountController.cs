...
using DrMturhan.Server.ViewModels.AccountViewModels;
...
namespace DrMturhan.Server.Controllers.api
{
    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<IActionResult> Register([FromBody]RegisterViewModel model, string returnUrl = null)
        {
            ...
            {
                // Add to roles
                var roleAddResult = await _userManager.AddToRoleAsync(currentUser, "Tercüman");
        ...
        private Task<Kullanici> GetCurrentUserAsync()
        {
